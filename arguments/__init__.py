...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.semantic_auto_experts = False
        self.semantic_auto_target_experts = 0
        self.semantic_auto_min_experts = 4
        self.semantic_auto_max_experts = 16
        self.semantic_auto_overcluster_factor = 3
        self.semantic_auto_sem_weight = 0.60
        self.semantic_auto_color_weight = 0.30
        self.semantic_auto_xyz_weight = 0.10
        self.semantic_auto_merge_threshold = 0.86
        ...
        self.triangle_support_band_scale = 2.5
        self.triangle_support_band_bias = 2.0
        self.triangle_support_sharpness_scale = 0.5
        self.triangle_support_min_weight = 0.10
        self.triangle_gt_grad_high_thresh = 0.16
        self.triangle_gt_peak_kernel = 3
        self.triangle_peak_min_pixels = 64
